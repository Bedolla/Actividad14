...
namespace Actividad.Mobile.ViewModels
{
    public class LeerBorrarViewModel : BaseViewModel
    {
        ...
        public LeerBorrarViewModel(IServicioUsuarios servicioUsuarios)
        {
        ...
        private async void Editar(Usuario usuario) => await Application.Current.MainPage.Navigation.PushAsync(new CrearEditarPage(usuario));
